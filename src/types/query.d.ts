 ...
 * ```
 */
export declare type Where<MT extends object = AnyObject> = Condition<MT>

export declare type WhereWithAndOr<MT extends object = AnyObject> =
  | Condition<MT>
  | AndClause<MT>
  | OrClause<MT>
/**
 ...
 */
export declare type FilterExcludingWhere<MT extends object = AnyObject> = Omit<
  Filter<MT>,
  'where'
>
/**
